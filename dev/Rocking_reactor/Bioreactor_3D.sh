...
for MIN_LEVEL in 5; do # 7 as default 
    for MAX_LEVEL in 7; do # 9 as default
	rm -rf Data_all Data_specific Fig_vor Fig_vol Fig_tr Fig_oxy Slices
	...
	mkdir Data_all Data_specific Fig_vor Fig_vol Fig_tr Fig_oxy Slices
	...
	./$NAME 0.25 5 25.0 $MIN_LEVEL $MAX_LEVEL
    done
done
